...
var nextTour = document.getElementsByClassName('nextTour')[0];


window.addEventListener('scroll' , ()=>{
    if (window.scrollY > 1620 && window.screen.availWidth < 400){
        nextTour.style.opacity = 1;
        nextTour.style.marginTop = "-40%";
    }
});
...
// mobile keyboard responsive website
